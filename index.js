...
const descriptionStr = 
    `A total of $${raised.toLocaleString()} has been raised for ${games} games. 
    Currently, ${numUnfunded} game${numUnfunded === 1 ? " remains" : "s remain"} unfunded. We need your help to fund these amazig games!`;

// create a new DOM element containing the template string and append it to the description container
const descParagraph = document.createElement("p");
descParagraph.textContent = descriptionStr;
